...
q = np.random.random((1, 8, 256, 32))
k = np.random.random((1, 8, 256, 32))
v = np.random.random((1, 8, 256, 32))
mask = np.random.random((1, 8, 1, 256))*0

# q = np.ones((1, 8, 256, 32))
# k = np.ones((1, 8, 256, 32))
# v = np.ones((1, 8, 256, 32))
# mask = np.ones((1, 8, 1, 256))
...
def infer():
    ...
    core.set_property("GPU", {"CONFIG_FILE": "/home/test/hongbo/opencl_demo/detr_custom_op/signal_sdpa_attr/1_8_256_32/mask_custom_layer.xml"})
