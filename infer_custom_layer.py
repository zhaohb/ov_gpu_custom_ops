...
# input_0 = np.random.randint(0, 256, size=(1, 3, 512, 512))

def infer():
    ov_model_path = "./custom_op_model/static_detr_sdpa.xml"

    core = ov.Core()
    core.add_extension("/home/test/hongbo/opencl_demo/detr_custom_op/cpu_custom_op/build/libopenvino_template_extension.so")
    core.set_property("GPU", {"CONFIG_FILE": "/home/test/hongbo/opencl_demo/detr_custom_op/custom_layer.xml"})
